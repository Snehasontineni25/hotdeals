function tabledata_handler(pageNum)
  ...
  $(document).ready(function () 
  {
          ...
          success:function(data){
             ...
             localStorage.setItem('someData',dataToStore);
              var deal_details_modal = document.createElement('div');
               ...
               $(close_element).css('marginTop' ,'-21px');
               ...
               $(price_table).css('marginRight','312px');
               var tr_mrp = document.createElement('tr');
               ...
               $(tr_mrp).append(mrp_element);
               $(tr_mrp).append(td_mrp);
               ...
               for(var i=0;i<data.OfferingLabs.length;i++)
               {
                 ...
                 $(tr_labs).attr('data-id',data.OfferingLabs[i].labId);
                 $(tr_labs).attr('data-pin',data.OfferingLabs[i].labPincode);
                    ...
                    $('#step2_next_btn').on('click', function()
                    {
                       ...
                       return i;
                         ...
                         var filter = /^\d{4}-(0[1-9]|1[0-2])-([0-2]\d|3[01]) (0\d|1[01]):[0-5]\d:[0-5]\d$/;
                          ...
                          if((current_time > hours_mnt) || (!filter.test(date_time)))
                          {
   ...
   function preview_handler(dataid,labname,labslug,dealname,deal_slug,deal_mrp,deal_discount,deal_finalprice,labarea)
   {
                  ...
                  var th_ptntinfo_head = document.createElement('th');
